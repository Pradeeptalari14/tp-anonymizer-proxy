...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/anonymizer-proxy/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-anonymizer-proxy.git
cd tp-anonymizer-proxy
```
...
```bash
kubectl port-forward deployment/tp-anonymizer-proxy 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── envoy_proxy.yaml     # Main configuration file
```
...
---
*Generated by [Anonymizer Proxy Studio](https://pradeeptalari14.github.io/portfolio/tools/anonymizer-proxy/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
