# 🔧 Troubleshooting Guide — Anonymizer Proxy
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-anonymizer-proxy/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/anonymizer-proxy/)
